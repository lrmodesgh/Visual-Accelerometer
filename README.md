...
1. Connect the Arduino Prototyping Hardware (I used Arduino Mega 2560) with the Accelerometer as shown in the following picture : ![](http://octodex.github.com/images/yaktocat.png)
